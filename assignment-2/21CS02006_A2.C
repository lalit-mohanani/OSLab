// Suppose an array of integers is given the size of the array is in the order of 10^6
// you define k threads (input)
// the elements of the array will be added 
// the kth thread does the summ of elements that are place at location module k
// finally all the partial sum will be added at the end and the final result will be printed.
